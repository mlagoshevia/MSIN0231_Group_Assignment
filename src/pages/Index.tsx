      ...
      <div className="p-4 max-w-4xl mx-auto">
        <div className="flex flex-col items-center mb-8 animate-slide-up">
          <div className="text-center">
            <div className={`inline-flex items-center px-3 py-1 ${randomIndex !== 0 ? "bg-white/10" : "bg-ucl-purple/10"} ${randomIndex !== 0 ? "text-white" : "text-ucl-purple"} rounded-full text-sm mb-3`}>
            ...
            <p className={`${textColor} max-w-lg mx-auto ${randomIndex !== 0 ? "opacity-80" : "text-gray-600"}`}>
